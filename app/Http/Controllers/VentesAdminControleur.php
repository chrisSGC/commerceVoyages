...
class VentesAdminControleur extends Controller{
    public function accueil(){
        ...
        return view('adminVentes')->with('listeVentesFinale', json_decode(json_encode($listeVentesFinale), FALSE))->with("listeVoyages", Voyage::all())->with("listeClients", Client::all());
    }
